  ...
  template:
    ...
    spec:
      ...
      - name: ray-worker
        ...
        command: ["/bin/bash", "-c", "--"]
        args:
          - {{ print "if ! $(which ray); then pip install ray[default]==" .Values.failsafes.ray.version "; fi;  ray start --num-cpus=" .Values.podTypes.rayWorkerType.CPUInteger " --num-gpus=" .Values.podTypes.rayWorkerType.GPU " --address=" (include "ray.headService" .) ":6379 --object-manager-port=22345 --node-manager-port=22346 --block" }}
